 ...
 */
 ...
 (function () {
   ...
   ulList.classList.add("tablist");

   const liList = ulList.querySelectorAll('li');

   [].forEach.call(liList, function (liList, index) {
      liList.setAttribute("role", "tab");
      let indexA = index + 1;
      let attrText = "tab-" + indexA;
      liList.setAttribute("id", attrText);
   });
