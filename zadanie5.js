/*
    ...
    -> this zwraca element DOM do którego podpięty jest eventListener, natomiast e.target zwraca konkretny element DOM, który został kliknięty
...
(function () {
  ...
  ulList.addEventListener('mousedown', function (e) {
    console.log('THIS ', this)
    console.log('TARGET ', e.target);
  }, false);
